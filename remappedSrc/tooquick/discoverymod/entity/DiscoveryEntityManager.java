...
public class DiscoveryEntityManager
{
    public static final EntityType<EntityAshSkeleton> ASH_SKELETON = Registry.register(
            ...
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, EntityAshSkeleton::new).dimensions(EntityDimensions.fixed(1f, 4f)).build()
    );

    public void onInitialize() {
        FabricDefaultAttributeRegistry.register(ASH_SKELETON, EntityAshSkeleton.createHostileAttributes()
